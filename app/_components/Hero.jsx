    ...
    <section className="bg-gray-50 flex flex-col items-center  ">
      <div className="flex flex-col overflow-hidden">
          ...
          titleComponent={
            <>
             ...
             <h1 className="text-4xl font-semibold text-black dark:text-white  ">
              ...
              <Link href={'/dashboard'} ><Button className='mt-6 mb-16 w-[200px] max-sm:mt-5 max-sm:-mb-5'>Dashboard</Button>
              </Link>
             </div>
            </>
          }
        >
         ...
         <div className='-mt-20 max-lg:mt-2 max-sm:mt-[10px]  '> <Faq /></div>
          </div>
            </div>
  ...
  <div className="p-8 md:p-12 lg:px-16 lg:py-24">
    <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right ">
     ...
     For?
      ...
      Take control of your finances with PennyWise! Start tracking your budget today and make smarter financial decisions.
      </p>

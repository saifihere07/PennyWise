  ...
  const list3 = [
    ...
    return (
      ...
      <footer className="bg-[#F9FAFB] max-sm:mt-6">
       <div
        className="sm:h-auto py-20 px-[150px] gap-7 text-black background max-md:py-5 max-md:px-5"
      >
        ...
        <div
          className="row2 my-7 border-y-[1px] border-[#333] flex justify-between items-center pt-14 pb-14 gap-44 max-md:flex-col"
        >
            ...
            <div className="menu1 flex flex-col gap-5">
              ...
              <div className="list1 gap-3 flex flex-col  text-[15px] text-[black]">
                {list1.map((item, index) => (
                  <a className="hover:underline" key={index} href="https://www.prodigi-studios.com/">
                    {item}
                  </a>
                ))}
              </div>
        ...
        <div
          className="copyright flex text-[#6D6D6D] justify-between max-sm:flex-col"
        >
          <div className="copyright flex max-sm:py-3 max-sm:flex-row max-sm:items-center max-sm:justify-center">
            ...
            <h6 className="text-black">Powered By <Link className="text-primary text-lg" href="https://www.prodigi-studios.com/">ProdigiStudios</Link></h6>
          </div>

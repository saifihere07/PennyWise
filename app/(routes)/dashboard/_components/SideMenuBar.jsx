    ...
    <div>
      ...
      >
        ...
        <div className="space-y-4 lg:space-y-0 lg:flex lg:space-x-8 mt-10">
          ...
          <Link href="/dashboard/budgets" className="block py-2 px-4 rounded hover:bg-gray-700 lg:hover:bg-transparent">
            Budgets
          </Link>
          <Link href="/dashboard/expenses" className="block py-2 px-4 rounded hover:bg-gray-700 lg:hover:bg-transparent">
            Expenses
          </Link>
          <Link href="/dashboard/upgrade" className="block py-2 px-4 rounded hover:bg-gray-700 lg:hover:bg-transparent">
            Upgrade
          </Link>
        </div>
      </div>
